    ...
    def _play_move(self, move):
        ...
        try:
            ...
            if self._game_state.is_game_over():
                ...
                if self._player_turn._player == self._top_left_player:
                    valid_moves = self._game_state._get_valid_moves(self._player_turn._player)
                    next_move = valid_moves[np.random.randint(len(valid_moves))]
                    time.sleep(1)
                    self._play_move(next_move)
        except:
            pass
